 ...
 *  
 * Původní proxy server, jen pro HTTPS.
 * Nyní již deprecated. Kód zde nechám, dokud jej úplně nepřepíšu do nového ProxyServer.java, pak toto smazat
 * 
 * @deprecated SMAZAT
 * @author Ondřej Směták <posta@ondrejsmetak.cz>
 */
public class ProxyServerOld {
	...
	public static boolean checkPort() {
		int localPort = -1; //ConfigurationRegister.getInstance().getPort();
	...
	public void run() {
		server = DefaultHttpProxyServer.bootstrap()
				.withPort(-1 /*ConfigurationRegister.getInstance().getPort()*/)
